...
// Formas fijas (normalizadas a radio 1) para asteroides grandes (size 3)
const LARGE_ASTEROID_SHAPES = [
  [
    [-0.133, -0.940], [0.387, -0.753], [0.300, -0.187], [0.867, -0.087],
    [0.700, 0.447], [0.367, 0.533], [-0.013, 0.880], [-0.633, 0.627],
    [-1.000, 0.027], [-0.833, -0.520],
  ],
];
...
class Asteroid {
  constructor(x, y, size = 3) {
    ...
    // Polígono irregular (los grandes pueden usar una forma fija predefinida)
  ...
  for (const b of bullets) {
    for (const a of asteroids) {
      if (!a.dead && !b.dead && dist(b, a) < a.radius) {
        ...
        if (Math.random() < 0.10) newPowerUps.push(new PowerUp(a.x, a.y));
      }
    }
  }
